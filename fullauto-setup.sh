...
server {
    root /etc/nginx/conf.d/handson-test;
...
<body>
    <div class="container">
        ...
        <div class="server-info">
            <p><strong>クライアントIP:</strong> CL-ADDRESS</p>
            <p><strong>↓</strong></p>
            <p><strong>サーバーIPアドレス:</strong> SV-ADDRESS</p>
            <p><strong>サーバーホスト名:</strong> SV-HOSTNAME</p>
        </div>
    </div>
</body>
</html>
...
<head>
    ...
    <style>
        ...
        h1 { color: #c0392b; }
        .statuscode { font-weight: bold; font-size: 1.2em; }
...
<body>
    <div class="container">
        ...
        <div class="statuscode">
            <p><strong>ステータスコード:</strong> STATUS-CODE</p>
        </div>
